...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($_POST["fname"]) < 3) {
        ...
        $nameErr = "Your username must have at least 3 characters";
    }
    ...
    if (strlen($_POST["password"]) < 8) {
        ...
        $passwordErr = "Your password must have at least 8 characters";
    }
                            ...
                            <div class="d-flex justify-content-center">
                                <fieldset class="fieldset-login">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button type="submit" id="submit" class="btn btn-primary"><a class="btn-link link-light" href="login.php" onclick="">Create Account</a></button>
                                    </div>
                    </form>
                    <!-- =======
                      <div class="div-btn">
